...
storiesOf("Appointment", module)
  ...
  .add("12 PM Appointment", () => <Appointment time="12pm" />)
  ...
  .add("Edit Form", () => <Form interviewers={interviewers} student="Aarij Anwer" interviewer={1} onSave={action("onSave")} onCancel={action("onCancel")} />)
