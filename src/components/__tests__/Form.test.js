...
describe("Form", () => {
  ...
  it("validates that the student name is not blank", () => {
    ...
    /* Test 1. validation is shown */
    expect(getByText(/student name cannot be blank/i)).toBeInTheDocument();

    /* Test 2. onSave is not called */
  ...
  it("validates that the interviewer cannot be null", () => {
    ...
    /* Test 3. validation is shown */
    expect(getByText(/please select an interviewer/i)).toBeInTheDocument();

    /* Test 4. onSave is not called */
    expect(onSave).not.toHaveBeenCalled();
  });
  ...
  it("calls onSave function when the name is defined", () => {
    ...
    /* Test 5. validation is not shown */
    expect(queryByText(/student name cannot be blank/i)).toBeNull();
    expect(queryByText(/please select an interviewer/i)).toBeNull();

    /* Test 6. onSave is called once*/
    expect(onSave).toHaveBeenCalledTimes(1);

    /* Test 7. onSave is called with the correct arguments */
